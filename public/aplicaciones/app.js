const projects = [
  ...
  },
  {
    ...
    category: 'formacion',
    description: 'Plataforma para trabajar las guías prácticas de la AESIA mediante contenidos, cuestionarios, flashcards, seguimiento y juegos.',
...
function render() {
  ...
  const visible = projects.filter((project) => {
    ...
    const haystack = `${project.title} ${project.kind} ${project.description} ${project.audience}`.toLocaleLowerCase('es');
    ...
    <article class="project" data-repo="${project.repo}">
      ...
      <div class="project-copy">
        <div>
          ...
          <div class="project-meta"><span class="tag status">${project.kind}</span><span class="tag">${project.audience}</span><span class="tag language" hidden></span></div>
